...
interface SelectionGroup {
  ...
  stateKey: 'companion' | 'budget' | 'mealTime';
}
...
const RestaurantSelectionForm: React.FC = () => {
  ...
  const handleSelection = (stateKey: 'companion' | 'budget' | 'mealTime', value: string) => {
          ...
          <View style={styles.optionsContainer}>
            {group.options.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.option,
                  selections[group.stateKey] === option.id && styles.selectedOption
                ]}
